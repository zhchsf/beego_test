...
func (c *UsersController) Prepare() {
  fmt.Println("starting............................... execute before actions")
  // c.Redirect("/", 302)
}

func (c *UsersController) Finish() {
...
func (c *UsersController) GetOne() {
  // sv := c.GetSession("user_id")
  // if sv == nil{
  //   c.SetSession("user_id", c.Ctx.Input.Param(":id"))
  // }

  // fmt.Println(c.GetSession("user_id"))
  // fmt.Println(c.Ctx.Input.Session("user_id"))

  // valid := validation.Validation{}
  // u := models.Users{Password: "88888888"}
  // b, _ := valid.Valid(&u)
  // if !b {
